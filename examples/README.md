...
See the [API reference (Redoc)](https://khdp.io/docs) and [OpenAPI spec](https://khdp.io/openapi.json) for every endpoint these scripts touch, and [`docs/quickstart.en.md`](../docs/quickstart.en.md) for a walkthrough that maps these scripts onto the CLI and MCP equivalents.
